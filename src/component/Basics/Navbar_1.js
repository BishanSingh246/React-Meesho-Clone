...
import Before_signin from './Before_signin'
const Navbar = () => {
                    ...
                    <div className="navbar-01 display-flex">
                        ...
                        {/* <div className="">
                            <div className="dropdown-01 ">
                                <div className="link-01">
                                    <div className="link-01-flex center">
                                        <i class="fa-solid fa-mobile-screen"></i>
                                        <div className="downloa-app-text ">Download App</div>
                                    </div>
                                </div>
                                <div className="dropdown-01-menu">
                                    <div className="dropdown-01-menu-01">
                                        <div className="dropdown-01-menu-01-01">Download From</div>
                                        <div className="dropdown-01-menu-01-02">
                                ...
                                <div className="supplier center navbar-text">
                                    <a href="https://supplier.meesho.com/?utm_source=meesho&utm_medium=website&utm_campaign=header">Become a Supplier
                                    </a>
                                </div>
                                <div className="right-border"></div>
                        ...
                        <div className="navbar-03 display-flex ">
                            ...
                            <div className="profile-cart navbar-text display-flex">
                                ...
                                <a href="./Sign_in" className="cart box-01">
                                    <i class="fa-solid fa-cart-shopping"></i>
                                    <div className="cart-text ">Cart</div>
                                </a>
                            </div>
